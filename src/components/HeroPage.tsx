const HeroPage = () => {
    return (
        <div className="rounded-md m-7 bg-slate-100 shadow-lg">
            <div className="w-full h-full flex flex-col justify-start items-center rounded-md m-8 sm:items-start lg:flex-row lg:justify-center lg:gap-1 lg:mx-20 lg:my-5">

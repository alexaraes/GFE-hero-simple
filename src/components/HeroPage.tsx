const HeroPage = () => {
    return (
        <div className="rounded-md m-7 bg-slate-100 shadow-lg">
            <div className="w-full h-full flex flex-col justify-start items-center space-y-10 rounded-md px-4 sm:m-4 sm:items-start lg:flex-row lg:justify-center lg:gap-1 lg:mx-8 lg:my-5">
